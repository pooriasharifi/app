      ...
      child:ListView.builder(
        ...
        return ListTile(
          ...
          style: ListTileStyle.drawer,
            title: Text('کارآموز',style: Get.textTheme.headline2,),
          iconColor: white,
          leading: Icon(Icons.circle),
          subtitle: Text('لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان گرافیک است، چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است، و برای شرایط فعلی تکنولوژی مورد نیاز، و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد، کتابهای زیادی در شصت و سه درصد گذشته حال و آینده، شناخت فراوان جامعه و متخصصان را می طلبد، تا با نرم ',style: Get.textTheme.subtitle1,),
          contentPadding: EdgeInsets.symmetric(vertical: 5),
          trailing: Text('12:11',style: Get.textTheme.subtitle1,),
        );
      })
    );
  }
                  ...
                  return  Slidable(
                    // Specify a key if the Slidable is dismissible.
                      ...
                      child: ListTile(
                        ...
                        iconColor: white,
                        leading: Icon(Icons.circle,color: itemTextFeild,),
                        trailing: Text('کارآموز',style: Get.textTheme.subtitle1,),
                        contentPadding: EdgeInsets.symmetric(vertical: 5),
